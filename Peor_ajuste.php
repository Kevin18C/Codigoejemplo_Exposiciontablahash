...
class MemoryManager {
    ...
    public function allocate($processName, $size) {
        ...
        if ($worstFitIndex != -1) {
            ...
            $this->memory[$worstFitIndex]['allocated'] = true;
            $this->memory[$worstFitIndex]['process'] = $processName;
            echo "Proceso '$processName' asignado a bloque de memoria $worstFitIndex.\n";
        } else {
